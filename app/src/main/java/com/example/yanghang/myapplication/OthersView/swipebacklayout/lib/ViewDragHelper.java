...
package com.example.yanghang.myapplication.OthersView.swipebacklayout.lib;
...
public class ViewDragHelper {
    ...
    public static final int EDGE_BOTH = EDGE_LEFT | EDGE_RIGHT;
    /**
     ...
     * <p>
     * This operation does not failedCount as a capture event, though
     ...
     * motion along that axis will not failedCount toward the slop check.
     *
