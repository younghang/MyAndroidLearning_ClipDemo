...
public class ClockView extends View {
    ...
    /**时钟最小尺寸*/
    private static final int CLOCK_MIN_SIZE=160;
    /**时钟及分钟的宽度*/
    private static final int HOUR_MINUTE_WIDTH = 12;
    /**秒钟的宽度*/
    private static final int SECOND_WIDTH = 6;
    /**时钟刻度的宽度*/
