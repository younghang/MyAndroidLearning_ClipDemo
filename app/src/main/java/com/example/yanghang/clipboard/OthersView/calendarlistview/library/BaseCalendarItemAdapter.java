 ...
 */
public class BaseCalendarItemAdapter<T extends com.example.yanghang.clipboard.OthersView.calendarlistview.library.BaseCalendarItemModel> extends BaseAdapter {
    ...
    public View getView(String date, T model, View convertView, ViewGroup parent) {
        ...
        if (model.getStatus() == com.example.yanghang.clipboard.OthersView.calendarlistview.library.BaseCalendarItemModel.Status.DISABLE) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GridView.LayoutParams layoutParams = new GridView.LayoutParams(com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemWidth, CalendarView.mItemHeight);
