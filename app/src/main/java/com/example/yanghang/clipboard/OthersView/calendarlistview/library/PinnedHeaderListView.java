...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
    ...
    protected com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter mLoadingFooter;

    protected com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter mLoadingHeader;
    private List<OnScrollListener> mOnScrollListeners = new CopyOnWriteArrayList<OnScrollListener>();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLoadingFooter = new com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter(context);
        mLoadingFooter.setState(LoadingFooter.State.TheEnd);
        addFooterView(mLoadingFooter.getView());
        mLoadingHeader = new com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter(context);
        mLoadingHeader.setState(com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter.State.Loading);
    ...
    public com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter getLoadingFooter() {
    ...
    public void pullToRefreshListViewOnScroll(AbsListView view,
        ...
        if (mLoadingFooter.getState() == com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter.State.Loading
                || mLoadingFooter.getState() == com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter.State.TheEnd) {
            return;
        }
        if (firstVisibleItem + visibleItemCount >= totalItemCount
                ...
                + getFooterViewsCount()) {
            mLoadingFooter.setState(com.example.yanghang.clipboard.OthersView.calendarlistview.library.LoadingFooter.State.Loading);
