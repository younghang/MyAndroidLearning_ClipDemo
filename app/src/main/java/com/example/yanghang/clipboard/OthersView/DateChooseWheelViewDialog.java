...
import com.example.yanghang.clipboard.OthersView.widget.OnWheelChangedListener;
import com.example.yanghang.clipboard.OthersView.widget.OnWheelScrollListener;
import com.example.yanghang.clipboard.OthersView.widget.WheelView;
import com.example.yanghang.clipboard.OthersView.widget.adapters.AbstractWheelTextAdapter;
...
public class DateChooseWheelViewDialog extends Dialog implements View.OnClickListener {
    ...
    private int dayInit;
    public DateChooseWheelViewDialog(Context context,String time, DateChooseInterface dateChooseInterface) {
        super(context);
    ...
    private void initialTime(String time) {
        yearInit =Integer.parseInt(time.split("-")[0]);
        monthInit =Integer.parseInt(time.split("-")[1]);
        dayInit =Integer.parseInt(time.split("-")[2]);
            ...
            switch (month){
                ...
                case 12:
                    for (int day = 1; day <= 31; day++){
                        ...
                        arry_date.add(strMonth + "月" + strDay + "日");
