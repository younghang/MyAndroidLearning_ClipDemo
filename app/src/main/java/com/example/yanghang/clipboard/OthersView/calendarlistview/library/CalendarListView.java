package com.example.yanghang.clipboard.OthersView.calendarlistview.library;
...
import com.example.yanghang.clipboard.OthersView.calendarlistview.library.*;
import com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarHelper;
import com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView;
...
/**
 * Created by example.yanghang.clipboard.OthersView on 16-7-21.
 */
public class CalendarListView extends FrameLayout {
    ...
    protected com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView calendarView;
    ...
    public void setCurrentSelectedDate(String current) {
        this.currentSelectedDate = current;
    }


    public CalendarListView(final Context context, AttributeSet attrs) {
        super(context, attrs);
        com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarHelper.init(context);
        ...
        calendarView = new com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView(context);
...
//                    currentSelectedDate= FragmentCalendar.DAY_FORMAT.format(Calendar.getInstance().getTime());
...
//                }
                ...
                Log.d(TAG, "onChanged: OnChanged");

                listView.setRefreshing(false);
                listView.getLoadingFooter().setState(LoadingFooter.State.TheEnd);
    ...
    protected void initListener() {
        calendarView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                int listViewHeight = CalendarListView.this.getHeight() - weekBar.getHeight() - com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight;
        ...
        calendarView.setOnDateSelectedListener(new com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.OnDateSelectedListener() {
            @Override
            public void onDateSelected(com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView calendarView, View view, String time, int pos) {
                if (!listView.smoothScrolling) {
                    currentSelectedDate = time;
                    int listPos = calendarListAdapter.getDataListIndexByDate(time);
                    Log.d(TAG, "onDateSelected: listPos" + listPos);
        ...
        listView.setOnSectionChangedListener(new PinnedHeaderListView.OnSectionChangedListener() {
            ...
            public void onSectionChanged(int newSection, int oldSection) {
                ...
                int diffMonth = com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarHelper.getDiffMonthByTime(lastSelectDate, currentSelectedDate);
                if (diffMonth == 0) {
                    diffMonth = com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarHelper.getDiffMonthByTime(calendarView.getSelectedDate(), currentSelectedDate);
                }
            }
        });
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.SelectedRowColumn selectedRowColumn = calendarView.getSelectedRowColumn();
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (status == Status.LIST_OPEN && dy > weekBar.getBottom() + com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight) {
                    return super.dispatchTouchEvent(ev);
                }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (status == Status.LIST_OPEN && curY < startY) {
                    if (dy > weekBar.getBottom() + com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight) {
                        return super.dispatchTouchEvent(ev);
                    } else {
                        return true;
                    }
                ...
                if (Math.abs(listView.getTranslationY()) >= calendarView.getHeight() - com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight
                        && curY < startY) {
                    listView.setTranslationY(-(calendarView.getHeight() - com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight));
                }
                ...
                calendarView.setTranslationY(calendarView.getTranslationY() + selectedRowColumn.row
                        * (curY - startY) / ((calendarView.getHeight() / com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight) - 1));
                startY = curY;
    ...
    private void animationToTop(com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.SelectedRowColumn selectedRowColumn) {
        status = Status.ANIMATING;
        ObjectAnimator objectAnimator1 = ObjectAnimator.ofFloat(this, "translationY", -(calendarView.getHeight() - com.example.yanghang.clipboard.OthersView.calendarlistview.library.CalendarView.mItemHeight));
