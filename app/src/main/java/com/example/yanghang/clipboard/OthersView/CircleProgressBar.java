...
/**
 * Created by yanghang on 2017/1/11.
 */
public class CircleProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typeArray.getColor(R.styleable.CircleProgressBar_circleColor, 0xFFFFFF);
    ...
    private void initVariable() {
        ...
        mTextPaint.setColor(Color.parseColor("#3F51B5"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if((mRadius+mStrokeWidth)>mXCenter)
        {
